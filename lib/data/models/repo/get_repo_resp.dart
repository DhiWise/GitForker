class GetRepoResp {
  ...
  GetRepoResp.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    nodeId = json['node_id'];
    name = json['name'];
    ...
    allowUpdateBranch = json['allow_update_branch'];
    useSquashPrTitleAsDefault = json['use_squash_pr_title_as_default'];
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.allowUpdateBranch != null) {
      data['allow_update_branch'] = this.allowUpdateBranch;
    }
    if (this.useSquashPrTitleAsDefault != null) {
      data['use_squash_pr_title_as_default'] = this.useSquashPrTitleAsDefault;
    }
    if (this.networkCount != null) {
